  ...
  <div class="header">
    <div class="navbar">
      <div class="navbar-logo navbar-left">
        <a href="/">
          <img src="../../assets/img/icon/snow.svg" alt="" />
          簌雪庭
          <p style="display: inline;font-size: 10px;color: #ccc;">白雪又簌簌，飘忽无定处</p>
        </a>
      ...
      <div class="navbar-nav navbar-right">
        <ul>
          <li>
            <a class="nav-item" :class="{ disabled: true }"> Sign in </a>
          </li>
          <li>
            <a class="nav-item" :class="{ disabled: true }"> 注册 </a>
          </li>
        </ul>
      </div>
    </div>
